...
export const origin = {
  ...
  photos: [
    {
      key: "then",
      src: "/assets/about/then.jpg",
      alt: "Samarth and Dhanush as children in 2006, the year they met.",
    },
    {
      key: "now",
      src: "/assets/about/now.jpg",
      alt: "Samarth and Dhanush today, photographed in the same arrangement as the 2006 picture.",
    },
  ],
};
