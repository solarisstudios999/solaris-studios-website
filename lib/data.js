...
export const team = [
  ...
  },
  {
    ...
    bio: "Shapes interaction, motion, and the small details that decide how a product feels in someone's hands.",
    phone: "+91 88617 27060",
    phoneHref: "tel:+918861727060",
    initial: "V",
  },
  {
    name: "Dhanush",
  ...
  },
  {
    ...
    bio: "Carries the visual language across brand, web, and content — from identity systems to launch-ready assets.",
    phone: "+91 81057 73035",
    phoneHref: "tel:+918105773035",
    initial: "L",
  },
];
...
export const testimonials = [
  {
    quote: "Solaris understood what we were trying to say before we did. Our launch finally felt like us.",
    author: "Founder",
    role: "Coaching program (placeholder)",
  },
  {
    quote: "Sharp work. They held the standard from the first call all the way to launch day.",
    author: "Co-founder",
    role: "D2C brand (placeholder)",
  },
  {
    quote: "It is rare to find one studio that can think across brand, web, and content. Solaris does.",
    author: "Marketing lead",
    role: "Services brand (placeholder)",
  },
];
...
export const projects = [
  {
    ...
    category: "Website",
    status: "Live website",
    summary: "A sustainability-led website for eco-friendly bricks and responsible construction.",
    description: "A website positioning Earthiva around eco-friendly brick manufacturing, greener materials, high-performance products, and a more responsible way to build.",
    url: "https://earthiva.in",
    domain: "earthiva.in",
    visual: "website",
    tags: ["Sustainable brand", "Product website", "Eco-friendly bricks"],
  },
  {
    title: "Arpitha Abhishek",
    category: "Website",
    status: "Live website",
    summary: "A business website for Arpitha Abhishek, built to present the brand and its services online.",
    description: "A business website designed and built for Arpitha Abhishek, giving the brand a clear, professional home online to present its services and reach customers.",
    url: "https://arpithaabhishek.com",
    domain: "arpithaabhishek.com",
    visual: "website",
    tags: ["Business website", "Web design"],
  },
  {
    title: "Shopaarna",
    category: "Website",
    status: "Live website",
    summary: "An e-commerce storefront for Shopaarna, built to showcase products and drive online sales.",
    description: "An online store built for Shopaarna, designed to showcase products clearly and make it easy for customers to browse and buy.",
    url: "https://shopaarna.in",
    domain: "shopaarna.in",
    visual: "website",
    tags: ["E-commerce", "Online store", "Web design"],
  },
  {
    title: "Kishan Plastic Industries",
    category: "Brand & Print",
    status: "Completed project",
    summary: "Product photography, catalog design, and business card design for K-Plaast Industries.",
    description: "A photography and print package for K-Plaast Industries' range of household plastic products, including product photography, a full product catalog, and business card design.",
    visual: "catalog",
    tags: ["Product photography", "Catalog design", "Business card design"],
  },
  {
    title: "S S Motors",
    category: "Content & Video",
    status: "Completed project",
    summary: "Content strategy and video editing for S S Motors, a Pure EV dealership.",
    description: "A content strategy and video editing engagement for S S Motors, a Pure EV dealership, built to grow their presence and tell their story online.",
    visual: "social",
    tags: ["Content strategy", "Video editing", "EV dealership"],
  },
  {
    title: "Earthiva",
    category: "Brand & Print",
    status: "Completed project",
    summary: "Product photography, catalog design, and business card design for Earthiva.",
    description: "A photography and print package for Earthiva, including product photography, catalog design, and business card design to round out the brand's presence beyond the website.",
    visual: "catalog",
    tags: ["Product photography", "Catalog design", "Business card design"],
  },
];
