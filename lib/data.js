...
export const clients = [
  ...
  },
  {
    ...
    /* Waiting on artwork. The homepage filters this list against disk, so
       until the file is there this entry renders nothing rather than a broken
       image - drop it in and it appears. No `url` yet either. */
  },
  {
    slug: "earthiva",
    name: "Earthiva",
