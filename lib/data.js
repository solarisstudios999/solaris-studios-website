...
export const projects = [
  {
    ...
    // One tall capture of the whole storefront. The frame pans down it as the
    // section scrolls, so the entire store is seen in a single gesture.
    fullShot: {
      src: "/assets/work/aarna/storefront-full.webp",
      width: 1200,
      height: 4564,
      alt: "The complete Aarna storefront from top to bottom: hero, collection grid, product rows, editorial sections and footer.",
    },
    shots: [
      {
        label: "Storefront",
